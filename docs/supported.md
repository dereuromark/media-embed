...
| [Sketchfab](https://sketchfab.com) | active | 3d | iframe |  |
| [SoundCloud](https://soundcloud.com) | active | audio | iframe |  |
| [Spotify](https://open.spotify.com) | active | audio | iframe |  |
| [Spreaker](https://www.spreaker.com) | active | audio | iframe | Episode URLs only; show pages expose no numeric ID in the URL. |
| [Streamable](https://streamable.com) | active | video | iframe |  |
| [TED](https://www.ted.com) | active | video | iframe |  |
| [TikTok](https://www.tiktok.com) | active | social | iframe |  |
...
| [YouTube](https://www.youtube.com) | active | video | iframe, thumbnail, timestamp |  |

...
return [
	...
	[
		...
		'status' => 'active',
		'category' => 'audio',
		'example-url' => 'https://music.apple.com/us/album/magical-mystery-tour/1441163490',
		'url-match' => [
			'https?://music\\.apple\\.com/([a-z]{2})/(album|playlist|song|music-video)/([^/?#]+)/([0-9]+)\\?i=([0-9]+)',
			'https?://music\\.apple\\.com/([a-z]{2})/(album|playlist|song|music-video)/([^/?#]+)/([0-9]+)',
		],
		'embed-width' => '660',
		'embed-height' => '450',
		'iframe-player' => 'https://embed.music.apple.com/$2/$3/$4/$5',
		'optional-params' => [
			'i' => 6,
		],
		'id' => '$2/$3/$4/$5',
	...
	[
		...
		'status' => 'active',
		'category' => 'social',
		'example-url' => 'https://mastodon.social/@trwnh/99664077509711321',
		'notes' => 'Federated: matches any instance host serving the /@user/id status format.',
		'url-match' => [
			'https?://([a-z0-9.-]+)/@([a-z0-9_]+)/([0-9]+)/?(?:[?#]|$)',
		],
		'embed-width' => '400',
		'embed-height' => '600',
		'iframe-player' => 'https://$2/@$3/$4/embed',
		'id' => '$2/$3/$4',
	],
	[
		'name' => 'Pinterest',
		...
		'status' => 'active',
		'category' => 'social',
		'example-url' => 'https://www.pinterest.com/pin/99360735500167749/',
		'url-match' => [
			'https?://(?:[a-z]{2,3}\\.)?pinterest\\.com/pin/([0-9]+)',
		],
		'embed-width' => '345',
		'embed-height' => '445',
		'iframe-player' => 'https://assets.pinterest.com/ext/embed.html?id=$2',
		'id' => '$2',
	],
];
